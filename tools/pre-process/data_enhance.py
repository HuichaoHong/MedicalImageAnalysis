...
#Data        ：2017-0903
#功能        ：
#使用说明    ：只需使用threadOPS(src,dst)即可完成一个文件夹src所有文件的数据增强，保存至dst
...
class DataAugmentation:
    ...
    def randomRotation(image, mode=Image.BICUBIC):
        ...
        rot=img.rotate(random_angle,expand = 1);
...
if __name__ == '__main__':
    threadOPS("C:/Users/Administrator/Desktop/you",
              "C:/Users/Administrator/Desktop/you")